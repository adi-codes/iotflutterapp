...
import 'package:iotcflutter_app/Notification/notificationHelper.dart';
import 'package:iotcflutter_app/sharedPrefs.dart';
...
class _CustomizedNotificationState extends State<CustomizedNotification> {
  ...
  void initState() {
    ...
    var startTime = DateTime(now.year, now.month, now.day, 7, 00); // eg 7 AM
    var endTime = DateTime(now.year, now.month, now.day, 10, 00); // eg 10 PM
